...
We also need to clean up the EVTYPE column. According to NOAA Storm database codebook mentioned before, there are only 48 primary weather events. But in the database, there are as many as `r length(unique(Storm$EVTYPE))` different events recorded.
